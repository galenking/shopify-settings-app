  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved value as @value" do
        ...
        post :create, {:value => { "name" => "invalid value" }}, valid_session
        assigns(:value).should be_a_new(Value)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested value" do
        ...
        Value.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => value.to_param, :value => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the value as @value" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Value.any_instance.stub(:save).and_return(false)
        put :update, {:id => value.to_param, :value => { "name" => "invalid value" }}, valid_session
        assigns(:value).should eq(value)
      end
